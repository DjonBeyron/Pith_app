...
--   • модуль «Hold on» (опубликован): урок-слово hold — закрепление фразы
...
-- ── Модуль «Hold on» (опубликован) ──────────────────────────────────────
-- Закрепление фразы (e2e/guest-memory.spec.js): у гостя слово hold уже на
-- шаге 3 — фраза «Hold on» приходит в повторение целиком (собери фразу)
insert into public.lessons (id, title, published, sort_order, script) values
('e2e0e000-0000-4000-8000-00000000000a', 'Старт', true, 0, '{"nodes": []}'),
('e2e0e000-0000-4000-8000-00000000000b', 'hold', true, 1, '{"nodes": []}'),
('e2e0e000-0000-4000-8000-00000000000c', 'Финал', true, 2, '{"nodes": []}')
on conflict (id) do nothing;

insert into public.curricula (id, title, published, lesson_ids) values
('e2e0e000-0000-4000-8000-0000000000ff', 'Hold on', true,
 '["e2e0e000-0000-4000-8000-00000000000a", "e2e0e000-0000-4000-8000-00000000000b", "e2e0e000-0000-4000-8000-00000000000c"]')
on conflict (id) do nothing;
