...
| `EnergyBadge.jsx` | Значок энергии в правом верхнем углу (везде, кроме профиля): молния + число или ∞ при подписке/админе; живёт на кэше профиля |
...
| `RaceBanner.jsx` | Баннер гонки вверху вкладки «Рейтинг»: тема, статус, прогресс подготовки; тап открывает страницу гонки |
