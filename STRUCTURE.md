...
| `public/rating/wreath-laurel.svg` | Лавровый венок с лучами (1 и 2 место рейтинга; серебро — CSS-фильтром), из макета «1 place.svg» |
| `public/rating/wreath-dense.svg` | Плотный венок (3 место рейтинга; бронза — CSS-фильтром), из макета «3 place.svg» |
