...
| `SlideVideo.jsx` | Видео-слой слайда (общий для рекомендаций и «Моих уроков»): active/near приходят от родителя из позиции скролла (без IntersectionObserver), постер, скелетон, чип звука, пауза по тапу |
