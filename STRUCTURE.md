...
| `rating-v2.css` | Стили вкладки «Рейтинг» и UserBadge: строки топа, места 1-2-3, карточки достижений с кнопками «Надеть», предпросмотр |
...
| Файл | Зачем нужен |
|------|-------------|
| `FeedTab.jsx` | Лента: опубликованные модули из `curricula`, сборка вкладки (данные, лайки/закладки, голоса сложности, сплэш); круг и звук — в хуках рядом; «Изучить фразу» открывает CurriculumView |
| `useFeedSound.js` | Хук звука ленты: soundOn в localStorage, жест пользователя (чип), откат при блокировке автозвука iOS, итоговый soundReady для слайдов |
| `useFeedCircle.js` | Хук бесконечного круга ленты: виртуализация TanStack, телепорт scrollTop с выключенным snap, перецентровка (settle/edge/init), активный слайд из позиции скролла |
