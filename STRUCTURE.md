...
| `streak-claim.css` | Стили праздничного окна «Награда получена!» (RewardClaimPopup) после «Забрать всё», плюс приглушённые done-ноды пути дней (rwNodeDone/rwNodeMilestoneDone) |
...
| `RewardsPopup.jsx` | Полноэкранное окно наград по макету: hero-прогресс до следующей вехи, путь дней, кнопки заморозки/автозаморозки, «Забрать награду»; открывается и вручную из профиля |
| `RewardsPath.jsx` | Вертикальный путь дней окна наград: до 3 забранных дней сверху (done), текущий день (claim), будущие дни (заблокированы), веха — отдельная золотая карточка |
| `RewardClaimPopup.jsx` | Праздничный оверлей после «Забрать всё»: +XP/+билеты, анимированный XP-бар уровня (как в LessonSummary, компактнее), кнопка «Отлично» |
