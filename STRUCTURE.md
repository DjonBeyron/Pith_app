...
| `lessons-chain-textures.css` | SVG-текстуры нодов в скандинавском духе (руны на старте, зигзаг-орнамент финала, решётка ромбов у уроков) + блик, подсвечивающий текстуру через движущуюся маску |
