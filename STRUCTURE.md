...
| Файл | Зачем нужен |
|------|-------------|
| `FeedTab.jsx` | Лента: опубликованные модули из `curricula`, бесконечный scroll-snap круг с тихой перецентровкой, виртуализация TanStack (в DOM — видимый слайд + overscan 2); «Изучить фразу» открывает CurriculumView |
