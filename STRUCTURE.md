...
| `streak-gate.css` | Полноэкранное окно серии при первом заходе в сутки (StreakGateOverlay/StreakGuardRow): фон в гамме стартового сплэша, карточка со счётчиком, приглушённый вариант для сорвавшейся серии, строка защит, кнопки |
