...
import { r, FLIGHT_MS, SPACER_EASE, anchorRow, whenSettled } from './flyPanelParts.js'
import { makeFlyGhost } from './flyPanelGhost.js'
...
export function flyPanelToChat(panelEl, nodeId, { send, reveal, onLanded, onCompensate, settleLayout, onRelease }) {
  ...
  // Клон панели поверх всего: панель доиграна, клон снят с неё один в один,
  // на своём слое, без анимаций разметки, «похудевший» — flyPanelGhost.js
  const { from, ghost } = makeFlyGhost(panelEl)
