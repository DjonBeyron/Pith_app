        ...
        {kind === 'freeze' ? (
          <>
            ...
            {isPro && (
              <p className="rwInfoPro">
                ...
                на второй пропущенный будний день за неделю, который PRO
                прощать уже не станет.
              </p>
            )}
            {hasFreeze ? (
          ...
          <>
            ...
            {isPro ? (
              ...
              <>
                <p>
                  Покупка даёт 2 заряда: они прикроют и два пропущенных дня
                  подряд, и два отдельных пропуска в разные недели —
                  сработает сама, без твоего участия. Повторная покупка
                  недоступна, пока заряды не кончатся. Стоит 3{' '}
                  <TicketIcon style={{ width: 13, height: 13, verticalAlign: '-2px' }} />.
                </p>
                <p className="rwInfoPro">
