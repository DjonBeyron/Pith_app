...
// Сколько точек-плейсхолдера рисовать на месте пропуска — общее и для самого
// пропуска (FillBlank.jsx), и для его тусклого двойника в переводе-подсказке
// (FillBlanksPanel.jsx): оба меряют один и тот же blankKind по одному индексу,
// значит и число точек должно браться из одного места.
export const BLANK_DOT_COUNT = { letters: 2, word: 5 }
