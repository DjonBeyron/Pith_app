...
export const PERF_FLAG_DEFS = [
  ...
  // «Видео через canvas» — обход дымки, на Android включён сам (videoCanvasMode.js):
  // videoNative выключает его там, videoCanvas включает на любом устройстве
  { key: 'videoNative', label: 'обычное видео (без canvas)' },
  { key: 'videoCanvas', label: 'canvas везде (тест)' },
]
