...
const CAP = 5
// Путь молнии — тот же, что у lucide-react Zap (id="1xq2db"): держим как
// заливаемый path (не <Zap/> напрямую), т.к. тут нужны два слоя цвета
// поверх друг друга (тёмная подложка + частичная заливка прогресса)
